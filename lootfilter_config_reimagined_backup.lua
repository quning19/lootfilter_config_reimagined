...
--- Filter Type: (Basic)
--- Filter Description: Ning's Filter

return {-- The below settings are all optional, default/false entries will be assumed for anything not included

    reload = "{pink}Ning's Filter {grey} 1/28/26 {Green}reloaded.", --Allows you to specify a custom message when reloading the filter in-game
    ...
    filter_titles = {"Early-Game", "Mid-Game", "End-Game", "Debug-Only"}, --Allows you to specify the text displayed for varying filter 'levels'
    filter_level = 2, --Indicates your currently active filter level, normally controlled via D2RLAN hotkey
    ...
    rules = {
        ...
        --Reminder to pick up Horadric Cube so it doesn't get left behind
         {
            code = "box",
        ...
        ---Rule 0e: Hides potion on ground 
        {
        ...
        --- Rule 2b:Good Bases (paladin shields thanks cogy) 
        {
       ...
       ---Rule 5: High Runes notification and ultra rune border and colors  
        ...
        -- eth 0 or 3 socket highlight
        {
            ...
            rarity = "1+",
            ethereal = true,
            notify = "Eth items: {purple}{name}",
            border = { 255, 105, 180, 190, 2 }, 
            -- area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        },
        -- eth 3 socket highlight
        {
            codes = "allitems",
            sockets = "3",
            maxsock = "3+",
            ...
            rarity = "1+",
            ethereal = true,
            notify = "Eth items with 3 Socket: {purple}{name}",
            border = { 255, 105, 180, 190, 2 }, 
            -- area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        },

        -- eth 4+ socket highlight
        {
            codes = "allitems",
            sockets = "4+",
            maxsock = "3+",
            ...
            rarity = "1+",
            ethereal = true,
            notify = "Eth items with 4+ Socket: {purple}{name}",
            border = { 255, 105, 180, 225, 2 }, 
            -- area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        },
        ...
        -- 4孔盾
        {
            ...
            quality = "2,3",
            rarity = "1+",
            notify = "Elite Shield with Sockets: {white}{name}",
        ...
        -- charm drop notify
        {
            ...
            quality = "6",
            border = { 255, 255, 100, 230, 2 },
            notify = "{yellow}Charm Dropped: {name}"
		},
